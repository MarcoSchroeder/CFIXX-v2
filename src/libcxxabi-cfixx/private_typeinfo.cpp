...
#pragma clang diagnostic ignored "-Wmissing-field-initializers"
                   ...
                   std::ptrdiff_t src2dst_offset)
    {
        ...
        // CFIXX-v2 modification start
        using ptr_t = unsigned long;
        ptr_t *metadata = (ptr_t *)0x7f0104846000UL;
        ptr_t first_index = (ptr_t)static_ptr >> 26;
        ptr_t second_index = (ptr_t)static_ptr >> 3 & ((1UL << 23) - 1UL);
        ptr_t *secondlevel = (ptr_t *)metadata[first_index];
        void **vtable = (void **)secondlevel[second_index];
        // void **vtable = *static_cast<void **const *>(static_ptr);
        // CFIXX-v2 modification end
